...
class TermApi(object):
    ...
    def term_get(self, **kwargs):  # noqa: E501
        """Simplified semantic search queries against the triple store  # noqa: E501

        This endpoint route is intended to provide some common semantic search operations against the triple store.  **NOTE**: This is an experimental operation. The SPARQL interface remains the most complete and powerful semantic search mechanism.  Provide one of `containing` or `predicate` as main parameter, along with associated auxiliary and optional parameters as described.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.term_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.term_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.term_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def term_get_with_http_info(self, **kwargs):  # noqa: E501
        """Simplified semantic search queries against the triple store  # noqa: E501

        This endpoint route is intended to provide some common semantic search operations against the triple store.  **NOTE**: This is an experimental operation. The SPARQL interface remains the most complete and powerful semantic search mechanism.  Provide one of `containing` or `predicate` as main parameter, along with associated auxiliary and optional parameters as described.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.term_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['containing', '_in', 'predicate', 'subject', 'object', 'limit', 'offset']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'containing' in params:
            query_params.append(('containing', params['containing']))  # noqa: E501
        if '_in' in params:
            query_params.append(('in', params['_in']))  # noqa: E501
        if 'predicate' in params:
            query_params.append(('predicate', params['predicate']))  # noqa: E501
